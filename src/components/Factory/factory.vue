<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/homeFactory' }" >首页</el-breadcrumb-item>
...
export default {
    ...
    created(){
      this.getDeviceList();
        ...
        console.log("this.parm   !!!  在factory   "+this.parm);
        this.queryInfo.idFactory=this.parm;
        console.log("this.queryInfo.idFactory   !"+this.queryInfo.idFactory);
    },
    data(){
      return {
    ...
    methods:{
      ...
      async getDeviceList(){
          ...
          const {data:res}=await this.$http.get("getDeviceInfoByFactory",{params:this.queryInfo});
          console.log(res);
        ...
        //   console.log("res 的admin  "+this.$parent.res.userName);
          console.log("res 的admin  "+res.userName);
