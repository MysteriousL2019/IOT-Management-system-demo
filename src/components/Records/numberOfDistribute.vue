<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>number of distribution</el-breadcrumb-item>
    </el-breadcrumb>
...
export default {
  ...
  methods: {
    ...
    async searchClick() {
      ...
      const { data: res } = await this.$http.post(
        "getRecordByTwoPoints",
        this.queryInfo
      );

    console.log("-----------------------------");
    console.log("1 "+res.smallerThan);
    console.log("2 "+res.equalTo);
    console.log("3 "+res.BiggerThan);   
    console.log("-----------------------------");
      ...
      xData.push(res.p1+" - "+res.p2 );

      xData.push(res.p2+" - 100");
      yData.push(res.smallerThan);
      yData.push(res.equalTo);
      yData.push(res.BiggerThan);
      console.log("********************************************");
      ...
      var option2 = {
        ...
        backgroundColor: "#fff",
        title: {
          text: "Chart of "+res.kind+" between "+this.queryInfo.date,
          // subtext: 'What users care most about voice assistants around the world',
          left: "center",
          textStyle: { color: "#000" },
        },
