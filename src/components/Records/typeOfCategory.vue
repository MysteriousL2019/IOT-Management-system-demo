    ...
    <div>
      ...
      <!-- 这里是， 点进来二级菜单之后 -->
        <el-breadcrumb-item :to="{ path: '/home' }">首页</el-breadcrumb-item>
            <el-breadcrumb-item>Category of statistics</el-breadcrumb-item>
         </el-breadcrumb>
    ...
    <el-card>
        <el-row :gutter="30">
            <el-col :span="5">
                ...
                <!-- <el-input placeholder="请输入Category Id" v-model="queryInfo.query" clearable @clear="getDeviceList">
...
export default{
    ...
    methods:{
        ...
        async getDeviceList(){
            ...
            const {data: res}=await this.$http.post("getRecordCategory",this.queryInfo);
